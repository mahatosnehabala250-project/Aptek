            ...
            <div className="rounded-2xl p-6 md:p-8 bg-white border border-gray-100 shadow-sm">
              ...
              {isSubmitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-600 mb-2">Service Required *</label>
          ...
          >
            ...
            >
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 rounded-xl bg-[#00A651]/10 flex items-center justify-center flex-shrink-0">
