    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <motion.p
          ...
          className="text-white text-base sm:text-lg md:text-xl max-w-2xl mx-auto mb-8 md:mb-10 leading-relaxed"
        ...
        >
          ...
          <a
            ...
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-4 border-2 border-white hover:border-[#00C462] text-white hover:text-[#00C462] font-semibold text-base sm:text-lg rounded-xl transition-all duration-300 bg-white/10 hover:bg-white/20 backdrop-blur-sm shadow-lg shadow-black/10"
          >
