    ...
    <footer className="relative bg-[#08080A] border-t border-white/5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 md:gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#00A651]/10 hover:bg-[#00A651]/20 border border-[#00A651]/20 hover:border-[#00A651]/40 text-[#00A651] font-semibold text-sm rounded-lg transition-all duration-300"
            >
            ...
            <ul className="space-y-3">
              {footerLinks.services.map((link) => (
                <li key={link.label}>
                  <a
                    href={link.href}
                    className="text-gray-500 text-sm hover:text-[#00A651] transition-colors duration-300"
                  >
                    {link.label}
                  </a>
                </li>
          ...
          <div>
            ...
            <div className="space-y-3 text-sm text-gray-500">
              ...
              <a
                ...
                className="block hover:text-[#00A651] transition-colors"
              >
                +91 99999 99999
              </a>
              <a
                href="mailto:info@aptekmedia.in"
                className="block hover:text-[#00A651] transition-colors"
              >
                info@aptekmedia.in
              </a>
      ...
      <div className="border-t border-white/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <button
            onClick={scrollToTop}
            className="p-2 rounded-lg bg-white/5 hover:bg-[#00A651]/10 text-gray-500 hover:text-[#00A651] transition-all duration-300"
