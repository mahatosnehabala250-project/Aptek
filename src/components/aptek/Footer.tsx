...
const socialLinks = [
  {
    label: 'Instagram',
    href: 'https://instagram.com/aptekmedia',
    icon: Instagram,
  },
  {
    label: 'Facebook',
    href: 'https://facebook.com/aptekmedia',
    icon: Facebook,
  },
  {
    label: 'LinkedIn',
    href: 'https://linkedin.com/company/aptekmedia',
    icon: Linkedin,
  },
  {
    label: 'YouTube',
    href: 'https://youtube.com/@aptekmedia',
    icon: Youtube,
  },
];
            ...
            <div className="flex items-center gap-3 mb-6">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="w-10 h-10 rounded-xl bg-white/5 hover:bg-[#00A651]/20 border border-white/10 hover:border-[#00A651]/30 flex items-center justify-center text-gray-400 hover:text-[#00A651] transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-[#00A651]/10"
                >
                  <social.icon size={18} />
                </a>
              ))}
          ...
          <div>
            ...
            <div className="space-y-4 text-sm text-gray-400">
              <div className="flex items-start gap-3">
                <MapPin size={16} className="text-[#00A651] flex-shrink-0 mt-0.5" />
                <div>
                  <p>APTEK Media</p>
