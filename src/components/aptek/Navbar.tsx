              ...
              <div className="flex items-center">
                ...
                <div className="w-8 h-8 md:w-9 md:h-9 mr-1.5 flex items-center justify-center">
                  <svg viewBox="0 0 40 40" className="w-full h-full">
                    ...
                    <path d="M20 4L4 36h10l6-12 6 12h10L20 4z" fill="url(#logoGrad)" />
            ...
            <div className="hidden md:flex items-center gap-1">
              {navLinks.map((link) => (
                <a
                  ...
                  className="px-4 py-2 text-sm font-medium text-gray-300 hover:text-[#00A651] transition-colors duration-300 relative group"
                >
                  {link.label}
            ...
            <div className="flex flex-col items-center gap-2 p-6">
              ...
              <div className="flex items-center mb-6">
                <div className="w-7 h-7 mr-1.5 flex items-center justify-center">
                  <svg viewBox="0 0 40 40" className="w-full h-full">
                    ...
                    <path d="M20 4L4 36h10l6-12 6 12h10L20 4z" fill="url(#logoGradMobile)" />
                    <path d="M20 14l4 8h-8l4-8z" fill="#8BC34A" opacity="0.6" />
                  </svg>
                </div>
                <div className="flex flex-col leading-none">
                  <span className="text-lg font-black tracking-tight text-white">APTEK</span>
              ...
              {navLinks.map((link, i) => (
                <motion.a
                  ...
                  className="w-full text-center py-4 text-lg font-medium text-gray-300 hover:text-[#00A651] transition-colors border-b border-white/5"
                >
                  {link.label}
                </motion.a>
              ))}
              <motion.a
                ...
                className="w-full text-center mt-4 py-4 bg-[#00A651] text-white font-bold text-lg rounded-xl"
              >
