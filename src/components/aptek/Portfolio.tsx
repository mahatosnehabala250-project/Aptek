    ...
    <section id="portfolio" className="relative py-20 md:py-28 bg-[#0E0E12]">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-10 md:mb-14">
          ...
          >
            Real <span className="text-gradient-gold">Work</span>, Real{' '}
        ...
        >
          ...
          <a
            href="https://wa.me/919999999999?text=Hi%20APTEK%2C%20I%20loved%20your%20portfolio%20and%20want%20to%20discuss%20a%20project."
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 px-6 py-3 bg-amber-500 hover:bg-amber-400 text-black font-bold text-sm rounded-xl transition-all duration-300 hover:shadow-lg hover:shadow-amber-500/20"
          >
